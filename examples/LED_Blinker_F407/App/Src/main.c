/******************************************************************************
 * @file        examples/LED_Blinker_F407/Src/main.c
 *
 * @description This code demonstrates the implementation of the developed RTOS for the
 *              STM32F4 microcontroller, tested on the STM32F407VG Discovery board.
 *              It includes 4 tasks for toggling the Discovery board user LEDs with
 *              different delays and managing periodic tasks.
 *
 * @date        2024-07-17
